...
public class client extends javax.swing.JFrame {
    ...
    public void start() throws NotBoundException, MalformedURLException, RemoteException
    {
             ...
             obj =   (AddServInt)Naming.lookup(addServerURL);
    }
    ...
    private void jButton12ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton12ActionPerformed
        ...
        b = Double.parseDouble(jTextField1.getText());
            ...
            {
            try { 
                jTextField1.setText(""+obj.add(a, b));
            ...
            {
            try { 
                jTextField1.setText(""+obj.sub(a, b));
            } catch (RemoteException ex) {
                Logger.getLogger(client.class.getName()).log(Level.SEVERE, null, ex);
            }
            }
            ...
            {
            try { 
                jTextField1.setText(""+obj.mul(a, b));
            } catch (RemoteException ex) {
                Logger.getLogger(client.class.getName()).log(Level.SEVERE, null, ex);
            }
            }
            ...
            {
            try { 
                jTextField1.setText(""+obj.div(a, b));
            } catch (RemoteException ex) {
                Logger.getLogger(client.class.getName()).log(Level.SEVERE, null, ex);
            }
            }
